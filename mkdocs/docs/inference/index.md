...
:material-file-code: **Source**: `isidet/src/inference/base_inferencer.py`
...
:material-file-code: **Source**: `isidet/src/inference/yolo_inferencer.py`
...
:material-file-code: **Source**: `isidet/src/inference/rfdetr_inferencer.py`
...
=== "YOLO — Single Image"
    ...
    for result in engine.predict("isidet/data/test1.jpg"):
...
=== "RF-DETR — Single Image"
    ...
    for result in engine.predict("isidet/data/test1.jpg", show=True):
        print(engine.get_summary(result))
    ```
